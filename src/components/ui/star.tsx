...
interface StarIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
  /** Renders the star solid (currentColor) instead of outlined — for a
   * "this one is set" state, since fill can't be reached via className
   * (the svg fill="none" attribute wins over an inherited utility class). */
  filled?: boolean;
}
