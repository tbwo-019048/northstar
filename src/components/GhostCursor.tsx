...
/**
 * A WebGL cursor-trail effect — ported (TypeScript) from React Bits'
 * "Ghost Cursor" (https://reactbits.dev/animations/ghost-cursor), MIT-style
 * copy-paste component, credit: davidhdev.
 *
 * Mounts as an absolutely-positioned, pointer-events:none overlay that fills
 * its *parent* element (not the whole page) — put it as a sibling inside
 * whatever box you want the trail to cover.
 */
